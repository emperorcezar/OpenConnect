...
for c in e.recipients.all():
    ...
    message = e.message + u"<br><br><span style='font-size: 10px;'>You received this email because of your previous relationship with our organization.  To unsubscribe, <a href='http://%s/emails/unsubscribe/[id]/'>click here</a>.%s" % (settings.DOMAIN, settings.POST_FOOTER)
